...
- [Installation Guide](https://github.com/ulygrz/RemindMed#installation-guide)
	...
	- [Uninstalling RemindMed](https://github.com/ulygrz/RemindMed#unstalling-remindmed)
- [Functions, Parameters and Architecture](https://github.com/ulygrz/RemindMed#functions-parameters-and-architecture)
	- [Changes in the Tasks' information](https://github.com/ulygrz/RemindMed#changes-in-the-task-information)
	...
	- [App Architecture](https://github.com/ulygrz/RemindMed#app-architectur)
- [Lookout](https://github.com/ulygrz/RemindMed#lookout)
- [The RemindMed App](https://github.com/ulygrz/RemindMed#the-remindmed-app)
  - [Create a New Task](https://github.com/ulygrz/RemindMed#)
  - [Save Location](https://github.com/ulygrz/RemindMed#save-location)
